...
# Files to check against (Added 21March emails.xlsx)
historical_files = [
...
print(f"Loading historical data from {historical_files}...")
...
print(f"\nTotal truly fresh records for March 22nd: {len(df_final)}")

OUTPUT_FILE = "22March emails.xlsx"
