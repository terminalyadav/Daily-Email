...
# Files to check against (all historical + 1 April)
historical_files = [
...
if not df_final.empty:
    print(f"\nTotal truly fresh records for April 2nd: {len(df_final)}")
else:
    print("\nTotal truly fresh records for April 2nd: 0")

OUTPUT_FILE = "2April emails.xlsx"
